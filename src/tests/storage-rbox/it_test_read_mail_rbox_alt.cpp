 ...
 * - change storage location of file to alt storage
 * - read mail from altstorage
 * - test input and output stream by comparing the resulting streams
 *
 */
TEST_F(StorageTest, read_mail_from_alt_storage) {
