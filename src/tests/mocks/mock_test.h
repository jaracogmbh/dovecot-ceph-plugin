...
class RboxIoCtxMock : public RboxIoCtx{
  public:
    ...
    MOCK_METHOD2(omap_set,int(const std::map<std::string, librados::bufferlist>& map,const std::string& oid));
    ...
    MOCK_METHOD0(nobjects_end,const librados::NObjectIterator& ());
