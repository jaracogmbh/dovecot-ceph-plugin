...
class StorageBackendFactory {
 public:
  ...
  static librmb::RadosCluster* create_cluster(StorageType storage_type) {
  ...
  static librmb::RadosStorage* create_storage(StorageType storage_type,librmb::RadosCluster *cluster) {
  ...
  static librmb::RadosDovecotCephCfg* create_dovecot_ceph_cfg(StorageType storage_type,librmb::RadosStorage *storage) {
  ...
  static librmb::RadosNamespaceManager* create_namespace_manager(StorageType storage_type,librmb::RadosDovecotCephCfg *dovecot_ceph_cfg) {
  ...
  static librmb::RadosMetadataStorage* create_metadata_storage(StorageType storage_type) {
